...
@section('content')
    <div class="container pt-5 mt-5">
        ...
        <div style="display: flex; justify-content: center; margin-bottom: 40px;">
            <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100"
                style="display: flex; gap: 10px; list-style: none; padding: 0; margin: 0;">
                <li><a href="{{ route('user.layanan.form', ['jenis' => 'alat_bajak']) }}"
                        class="filter-btn {{ Request::is('layanan/alat_bajak') ? 'active' : '' }}">Alat Bajak</a></li>
                <li><a href="{{ route('user.layanan.form', ['jenis' => 'alat_panen']) }}"
                        class="filter-btn {{ Request::is('layanan/alat_panen') ? 'active' : '' }}">Alat Panen</a></li>
                <li><a href="{{ route('user.layanan.form', ['jenis' => 'tenagatanam']) }}"
                        class="filter-btn {{ Request::is('layanan/tenagatanam') ? 'active' : '' }}">Tenaga Tanam</a></li>
            </ul>
        </div>

        {{-- Gambar --}}
        <div class="mb-4 text-center">
            <img src="{{ asset('assets/images/logos/alatpanen.jpg') }}" alt="Alat Panen"
        ...
        <div class="text-center mt-4 mb-5">
            ...
            @else
                <a href="{{ route('login') }}?redirect=layanan&message=login_sewa"
                    class="btn btn-lg px-4 text-white shadow-sm" style="background-color: #f5b93a; border-radius: 10px;">
                    ...
                    <form action="{{ route('pengajuansewa.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::check() ? Auth::user()->nama_lengkap : '-' }}" disabled>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="lama_sewa_hari" id="lama_sewa_hari" class="form-control"
                                min="1" required>
                        </div>
    ...
    {{-- Script untuk menghitung total biaya sewa --}}
    <script>
