<aside class="left-sidebar text-dark" id="sidebar">
  ...
  <nav class="sidebar-nav scroll-sidebar" data-simplebar>
    <ul id="sidebarnav" class="nav flex-column">
      ...
      <!-- Farmers Dropdown -->
      <li class="sidebar-item">
        <a class="sidebar-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#petaniMenu" role="button" aria-expanded="false" aria-controls="petaniMenu">
          <div><i class="ti ti-user"></i> Petani</div>
      ...
      <li class="sidebar-item">
        <a class="sidebar-link" href="{{ route('jenis-sewa.index') }}">
          <i class="ti ti-assembly"></i> Jenis Sewa
        </a>
      </li>
      ...
      <li class="sidebar-item">
        <a class="sidebar-link" href="{{ route('pengajuansewa.index') }}">
          <i class="ti ti-clipboard-text"></i> Pengajuan Sewa
        </a>
      </li>

      <li class="sidebar-item">
        <a class="sidebar-link" href="{{ route('pengajuanpadi.index') }}">
          <i class="ti ti-clipboard-text"></i> Pengajuan Padi
        </a>
      </li>
