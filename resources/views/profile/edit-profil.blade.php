                    ...
                    <form action="{{ route('profile.updateProfil') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 text-center">
                                @if (Auth::user()->logo)
                                    <img src="{{ asset('storage/' . Auth::user()->logo) }}" class="rounded-circle img-thumbnail mb-2" width="120" height="120" alt="Foto Profil">
                                @else
                                    <img src="https://via.placeholder.com/120" class="rounded-circle img-thumbnail mb-2" alt="Default Foto">
                                @endif
