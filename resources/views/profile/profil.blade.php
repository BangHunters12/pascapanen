                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 text-center mb-3">
                            @if(Auth::user()->logo)
                                <img src="{{ asset('storage/' . Auth::user()->logo) }}" class="rounded-circle img-thumbnail" width="150" height="150" alt="Foto Profil">
                            @else
                                <img src="https://via.placeholder.com/150" class="rounded-circle img-thumbnail" alt="Foto Default">
                            @endif
                        </div>
